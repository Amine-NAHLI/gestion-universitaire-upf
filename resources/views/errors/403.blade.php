...
<head>
    ...
    <title>403 — Accès refusé | UPF</title>
    @vite(['resources/css/app.css'])
</head>
<body class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center font-sans antialiased">
    <div class="text-center px-6 py-12">
        <div class="inline-flex items-center justify-center w-24 h-24 bg-red-50 dark:bg-red-950/30 rounded-3xl mb-6">
            <span class="text-5xl font-black text-red-400">403</span>
        </div>
        <h1 class="text-2xl font-extrabold text-gray-800 dark:text-white mb-2">Accès refusé</h1>
