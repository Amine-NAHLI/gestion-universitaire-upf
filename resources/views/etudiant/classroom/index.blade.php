...
@section('title', 'Espace Classroom')
@section('page-title', 'Mes Modules & Classroom')
...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="group bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <div class="p-8">
                ...
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <p class="text-xs font-black text-gray-400 uppercase tracking-widest">Professeur</p>
                        <p class="text-xs font-bold text-gray-700 dark:text-gray-300">{{ $prof->user->full_name }}</p>
                    </div>
                    @else
                    <div class="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 font-black text-xs">
                        ?
                    </div>
                    <div>
                        <p class="text-xs font-black text-gray-400 uppercase tracking-widest">Professeur</p>
                        <p class="text-xs font-bold text-gray-400 italic">Non assigné</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-2xl mb-6">
                    <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Dernière annonce</p>
        ...
        <div class="col-span-full py-20 text-center">
            <p class="text-gray-500 font-bold italic">Aucun module assigné à votre niveau pour le moment.</p>
        </div>
        @endforelse
    </div>
</div>
