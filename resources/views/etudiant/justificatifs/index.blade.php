    ...
    <div class="lg:col-span-1">
        <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden sticky top-8">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                <h3 class="text-sm font-black text-gray-800 dark:text-white uppercase tracking-widest">Déposer un justificatif</h3>
            </div>
            <div class="p-6">
                ...
                <form action="{{ route('etudiant.justificatifs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div class="space-y-1">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Absence concernée</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Motif de l'absence</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Document (PDF, JPG, PNG)</label>
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-sm font-bold text-gray-500">Toutes vos absences sont déjà justifiées ou en cours de traitement.</p>
                </div>
                @endif
            </div>
        </div>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden">
            <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                <h3 class="text-lg font-black text-gray-800 dark:text-white uppercase tracking-wider">Mes Justificatifs</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-900/50">
                            <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Absence / Module</th>
                            <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">Date Dépôt</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                            <td class="px-6 py-4">
                                ...
                                <p class="text-[10px] text-gray-400">Séance du {{ $justif->absence->seance->date->format('d/m/Y') }}</p>
                            </td>
                            <td class="px-6 py-4">
