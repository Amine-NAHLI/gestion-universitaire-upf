...
@section('title', 'Saisie Cahier de Textes')
@section('page-title', 'Cahier — ' . $seance->module->nom)
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-900/50 p-6 rounded-3xl border border-gray-100 dark:border-gray-700 flex flex-wrap gap-8">
        ...
        <div>
            <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-1">Horaire</span>
        ...
        <div>
            <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-1">Groupe</span>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl overflow-hidden">
        <div class="p-8 border-b border-gray-50 dark:border-gray-700">
            <h3 class="text-lg font-black text-gray-800 dark:text-white uppercase tracking-wider">Compte-rendu de la séance</h3>
        </div>
        <form action="{{ route('professeur.cahier.store', $seance) }}" method="POST" class="p-8 space-y-6">
            @csrf
            
            <div class="space-y-1">
                <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Nature de la séance</label>
            ...
            <div class="space-y-1">
                <label for="objectif" class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Objectif pédagogique</label>
                <textarea name="objectif" id="objectif" rows="3" required minlength="10"
                          placeholder="Décrivez l'objectif principal de cette séance..."
            ...
            <div class="space-y-1">
                <label for="contenu" class="text-[10px] font-black text-gray-400 uppercase tracking-widest">Détails du contenu (optionnel)</label>
                <textarea name="contenu" id="contenu" rows="6" 
                          placeholder="Chapitres abordés, exercices effectués, outils utilisés..."
            ...
            <div class="pt-6 flex justify-end gap-4">
                <a href="{{ route('professeur.cahier.index') }}" class="px-8 py-4 text-xs font-black text-gray-400 uppercase tracking-widest hover:text-gray-600 transition-colors">Annuler</a>
