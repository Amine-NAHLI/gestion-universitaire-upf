                ...
                <div class="p-6 flex flex-col md:flex-row md:items-center gap-4 hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            <i class="fas fa-users mr-1"></i>{{ __('Groupe :') }} {{ $s->groupe->nom }}
                        </p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const el = document.getElementById('calendar-prof');
    const calendar = new FullCalendar.Calendar(el, {
        ...
        events: '{{ route("professeur.edt.data") }}',
        editable: false,
        selectable: false,
        eventClick: function (info) {
            ...
            Swal.fire({
                ...
                html: `<div class="text-left space-y-2 mt-2">
                    ...
                    <p><span class="text-gray-400 text-xs uppercase font-bold">Groupe :</span> <span class="font-bold">${p.groupe}</span></p>
