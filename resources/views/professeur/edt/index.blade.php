...
<div class="space-y-8">
        ...
        <div class="relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20">
                    ...
                    <p class="text-[10px] text-white/80 font-black uppercase tracking-widest mb-1">{{ $p->groupe->nom }}</p>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-black text-gray-800 dark:text-white uppercase tracking-wider">{{ __('Planning Complet') }}</h3>
        </div>
            ...
            <div class="divide-y divide-gray-100 dark:divide-gray-700">
                ...
                <div class="p-6 flex flex-col md:flex-row md:items-center gap-4 md:gap-8 hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs font-black text-indigo-500 uppercase tracking-widest flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                            </svg>
                            {{ __('Groupe :') }} {{ $s->groupe->nom }}
                        </p>
                    </div>

                    <div class="flex items-center gap-6">
                        <div class="text-right">
                            <span class="text-[10px] font-black text-gray-400 uppercase tracking-widest block mb-1">{{ __('Salle') }}</span>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl p-12 text-center border border-gray-100 dark:border-gray-700 shadow-xl">
            <p class="text-gray-500 dark:text-gray-400 font-bold italic">{{ __('Aucune séance planifiée dans votre emploi du temps.') }}</p>
        </div>
        @endforelse
    </div>
</div>
